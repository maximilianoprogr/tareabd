...
<body>
    ...
    <?php elseif ($resultados_publicados): ?>
        <p style="font-family: Arial, sans-serif; font-size: 18px; color: #333; margin-bottom: 20px;">Formulario de Evaluación (Modo Consulta)</p>
        <form style="margin-top: 20px; padding: 20px; border: 1px solid #ccc; border-radius: 10px; background-color: #f9f9f9;" disabled>
            <div style="margin-bottom: 15px;">
                <label for="calidad_tecnica" style="font-family: Arial, sans-serif; font-size: 14px; color: #555;">Calidad Técnica:</label>
                <input type="checkbox" id="calidad_tecnica" name="calidad_tecnica" value="1" style="margin-left: 10px;" disabled>
            </div>

            <div style="margin-bottom: 15px;">
                <label for="originalidad" style="font-family: Arial, sans-serif; font-size: 14px; color: #555;">Originalidad:</label>
                <input type="checkbox" id="originalidad" name="originalidad" value="1" style="margin-left: 10px;" disabled>
            </div>

            <div style="margin-bottom: 15px;">
                <label for="valoracion_global" style="font-family: Arial, sans-serif; font-size: 14px; color: #555;">Valoración Global:</label>
                <input type="checkbox" id="valoracion_global" name="valoracion_global" value="1" style="margin-left: 10px;" disabled>
            </div>

            <div style="margin-bottom: 15px;">
                <label for="argumentos_valoracion" style="font-family: Arial, sans-serif; font-size: 14px; color: #555;">Argumentos Valoración Global:</label>
                <textarea id="argumentos_valoracion" name="argumentos_valoracion" style="width: 100%; height: 80px; padding: 10px; border: 1px solid #ccc; border-radius: 5px; font-family: Arial, sans-serif; font-size: 14px; color: #555;" disabled></textarea>
            </div>

            <div style="margin-bottom: 15px;">
                <label for="comentarios_autores" style="font-family: Arial, sans-serif; font-size: 14px; color: #555;">Comentarios a Autores:</label>
                <textarea id="comentarios_autores" name="comentarios_autores" style="width: 100%; height: 80px; padding: 10px; border: 1px solid #ccc; border-radius: 5px; font-family: Arial, sans-serif; font-size: 14px; color: #555;" disabled></textarea>
            </div>
        </form>
    <?php endif; ?>
